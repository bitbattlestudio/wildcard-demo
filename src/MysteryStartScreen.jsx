...
export default function MysteryStartScreen({ onStart }) {
  return (
    <motion.section className="screen start-screen mystery-start-screen" {...SCREEN_TRANSITION}>
      ...
      <div className="start-content mystery-start-content">
        <div className="mystery-start-box-wrap">
          ...
          >
            <img className="mystery-box-image mystery-box-image-start" src={ASSETS.mysteryBox} alt="Mystery box" />
          </motion.div>
        </div>
        ...
        <h1 className="start-title">Unlock your sneaker reward</h1>
