...
export default function WebFortuneCookieScreen({
  ...
  const boxSrc = isOpening || isResult ? ASSETS.fortuneCookieOpen : ASSETS.fortuneCookie
          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            {isPostCheckout && !isProcessing && (
              ...
              >
                ...
                {/* ── wildcard Fortune Cookie Widget ─────────────────── */}
                <div className="web-tails-widget">
                  ...
                  <div className="web-tails-widget-hd">
                    ...
                    <span className="web-tails-widget-tag">Fortune Cookie Reward</span>
                  </div>
                      ...
                      >
                        <div className="web-tails-offer-left">
                          ...
                          <p className="web-tails-offer-body">
                            Omnilux has partnered with wildcard to let you crack a Fortune Cookie for a chance to win back your purchase.
                          </p>
                        ...
                        <div className="web-tails-offer-right">
                          <div className="web-tails-box-stage">
                            ...
                            >
                              <img className="web-tails-box-img" src={boxSrc} alt="Fortune Cookie" />
                            </motion.div>
                          </div>
                          <button
                            type="button"
                    ...
                    {isRevealPhase && (
                      ...
                      >
                          ...
                          {isResult ? (
                            ...
                            >
                              <div className="web-tails-open-prompt">
                                {isOpening ? 'Cracking…' : 'Tap your fortune cookie to crack!'}
                              </div>
                            </motion.div>
                          )}
                        </AnimatePresence>
                        ...
                        <div className="web-tails-reveal-box-wrap">
                          ...
                          >
                            <img className="web-tails-reveal-box-img" src={boxSrc} alt="Fortune Cookie" />
        ...
        {(isMysteryCheckout || isMysteryProcessing) && (
          ...
          >
            ...
            >
              ...
              <div className="web-tails-modal-merchant">Fortune Cookie · Omnilux Order</div>
